		 		...
		 		<br><br><br>
				    ...
				    <div id="practice">
				    	...
				    	<?php
					 			...
					 			$var = new Query();
								$var->sql = 'select id_practica, nombre , descripcion, direccion_url from practicas';
								...
								echo ' <table class="datos" border="2px" >';
					 			...
					 			foreach($practicas as $u){
					 				...
					 				$urr= $u->direccion_url;
										...
										echo '<td colspan=""><a href="'.$urr.'?idp='.$idPr.'"><input type="button" value="ASIGNAR PRACTICA"></a></td>';
